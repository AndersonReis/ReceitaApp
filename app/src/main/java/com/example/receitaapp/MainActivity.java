...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button botaoBolo = findViewById(R.id.Button_bolo);
        ...
        Button botaoTorta = findViewById(R.id.Button_torta);
        ...
        Button botaoCookie = findViewById(R.id.Button_cookie);
        ...
        Button botaoSorvete = findViewById(R.id.Button_sorvete);
